...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(CallOrPassAnalyzerCodeFixProvider))]
    [Shared]
    public class CallOrPassAnalyzerCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds =>
            ImmutableArray.Create(CallOrPassAnalyzerAnalyzer.DiagnosticId);
